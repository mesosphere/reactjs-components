...
class ConfirmExample extends Util.mixin(BindMixin) {
  get methodsToBind() {
    return ["handleOpenConfirm", "handleButtonCancel", "handleButtonConfirm"];
  }
  ...
  render() {
    return (
      <ComponentWrapper
        title="Confirm"
        srcURI="https://github.com/mesosphere/reactjs-components/blob/master/src/Confirm/Confirm.js"
      >
        <PropertiesAPIBlock
          propTypesBlock={"PROPTYPES_BLOCK(src/Confirm/Confirm.js)"}
        />
